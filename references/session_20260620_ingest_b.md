...
- Typical content: <vendor> study applications, paid consulting opportunities, job alerts
...
- When: During routine finch scans when new emails arrive from sources like <vendor>, job alerts, service notifications
