...
=======
- `~/.hermes/commons/journals/` — 2,929 files (legacy/default profile)
- `~/.hermes/profiles/indigo/commons/journals/` — 7,667 files (indigo profile, active)

The indigo profile path contains the active, up-to-date journals. The skill's `ingest-script-pattern.md` incorrectly references `~/.hermes/commons/journals/`. **Fix:** Always use `~/.hermes/profiles/indigo/commons/journals/`.
>>>>>>> Stashed changes
