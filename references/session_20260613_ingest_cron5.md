...
|---|------------|--------|--------|
| 1 | `escalation` | ocas-finch/scan-0600 | Critical finding: "Google Workspace MCP server unreachable" — both <user-google-email> and <agent-email> affected. All 3 Google Workspace tools (Gmail, Calendar, Drive) impacted. |
